    ...
    <div id="Wrap">
      ...
      <footer id="footer">
		...
		<div class="f_menu container">
			<a @click="goTermsofUse()">펑크비즘 이용약관</a>
		</div>
        <div class="sns">
      ...
      <aside id="quick_menu">
        ...
        <div class="etc_link">
          <div class="inner">
            ...
            <div>
              <p><a class="alert-view" data-title="Comming Soon" data-text="It will be in service soon."><span>회사소개서</span> <i class="xi-download"></i></a></p>
