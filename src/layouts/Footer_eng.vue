    ...
    <div id="Wrap">
      ...
      <footer id="footer">
		...
		<div class="f_menu container">
			<a @click="goTermsofUse()">Terms of Use for Punkvism</a>
		</div>
        <div class="sns">
      ...
      <aside id="quick_menu">
        ...
        <div class="etc_link">
          <div class="inner">
            <button type="button"><p><span></span> <i class="xi-valign-bottom"></i></p></button>
            <div>
              <p><a class="alert-view" data-title="Comming Soon" data-text="It will be in service soon."><span>Company</span> <i class="xi-download"></i></a></p>
              <p><a class="alert-view" data-title="Comming Soon" data-text="It will be in service soon."><span>FS</span> <i class="xi-download"></i></a></p>
            </div>
          </div>
        </div>
  ...
  toggleGlobal() {
   ...
   goTermsofUse() {
      ...
      if (this.$route.path.includes('kor')) {
        targetPath = '/kor/etcTermsofUse'
      } else if (this.$route.path.includes('idn')) {
        targetPath = '/idn/etcTermsofUse'
      } else {
        targetPath = '/eng/etcTermsofUse'
      }
