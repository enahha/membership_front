      ...
      <div id="sub_container" class="membership1_wrap">
        ...
        <section class="mem_sec01 full_bg container">
          <h3>
            ...
            Please select the<br class="mo_only_sm" /> NFT to use for your reservation.
          </h3>
          <div class="nft_select">
  
            <a v-if="getPunky == true || getGenesis == true" href="/#/eng/membership/membership_punk1" class="is-active">
              <p><img src="_img/membership/member1_img1.png" class="wp100" alt="" /></p>
              <p>Genesis , Punky Kongz</p>
            </a>
            <a v-else>
              <p><img src="_img/membership/member1_img1.png" class="wp100" alt="" /></p>
              <p>Genesis , Punky Kongz</p>
            ...
            <a v-if="getAlya == true || getFitri == true" href="/#/eng/membership/membership_alya1" class="is-active">
           ...
           <div v-if="!getWalletAddress"><a @click.prevent="connectPhantomWallet()" class="btn btn-purple w260">NFT Authentication</a></div>
        </section>
